...
from envs.mujoco_meta.gym.envs import mujoco
mujoco.AntEnv
```
...
from envs.mujoco_meta.gym.envs.mujoco import ant
ant.AntEnv
```
...
* `gym-foo/gym_foo/__init__.py` should have:
  ```python
  from envs.mujoco_meta.gym.envs.registration import register
...
2. Import your environment into the `__init__.py` file of the collection. This file will be located at `/gym/envs/my_collection/__init__.py`. Add `from envs.mujoco_meta.gym.envs.my_collection.my_awesome_env import MyEnv` to this file.
