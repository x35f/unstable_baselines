...
from envs.mujoco_meta.gym import spaces
from envs.mujoco_meta.gym.envs.box2d.car_dynamics import Car
from envs.mujoco_meta.gym.utils import colorize, seeding
...
class CarRacing(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.viewer is None:
            from envs.mujoco_meta.gym.envs.classic_control import rendering
