...
from unstable_baselines.envs.mujoco_meta.gym.envs.box2d.car_dynamics import Car
from unstable_baselines.envs.mujoco_meta.gym.utils import colorize, seeding
...
class CarRacing(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.viewer is None:
            from unstable_baselines.envs.mujoco_meta.gym.envs.classic_control import rendering
